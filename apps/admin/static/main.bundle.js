...
/***/ "../../../../../src/app/components/model-delete/model-delete.component.html":
/***/ (function(module, exports) {

module.exports = "\r\n<h2>Delete {{ modelName }}</h2>\r\n\r\n<p class=\"lead\">\r\n  Are you sure you want to delete {{ appName }}/{{ modelName }}: {{ modelKey }}?\r\n</p>\r\n\r\n<button class=\"btn btn-danger\" (click)=\"delete()\">Delete</button>\r\n<a class=\"btn btn-secondary\" [routerLink]=\"['/view', appName, modelName, modelKey]\">Cancel</a>\r\n"

/***/ }),

/***/ "../../../../../src/app/components/model-delete/model-delete.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ModelDeleteComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_admin_api_service__ = __webpack_require__("../../../../../src/app/lib/admin-api.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var ModelDeleteComponent = (function () {
    function ModelDeleteComponent(adminAPIService, route, router) {
        this.adminAPIService = adminAPIService;
        this.route = route;
        this.router = router;
    }
    ModelDeleteComponent.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.adminAPIService.post('/delete', {
                            appName: this.appName,
                            modelName: this.modelName,
...
var _a, _b, _c;
//# sourceMappingURL=model-delete.component.js.map
...
var ModelEditComponent = (function () {
    ...
    ModelEditComponent.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, codeMirrorKeys, i, fieldName, fieldObj, value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.appName = this.route.snapshot.paramMap.get('app');
